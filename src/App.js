  ...
  return(
    <div className="header">
      <div className="logoContainer">
        <img className="logo" src="https://img.freepik.com/free-vector/detailed-chef-logo-template_23-2148986823.jpg?size=338&ext=jpg&ga=GA1.1.1448711260.1707091200&semt=ais"/>
      </div>
...
const RestaurantCard=(props)=>{
  ...
  return (
    <div className="rest-card">
      <img className="rest-logo" alt="rest-logo" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/" +
